        ...
        <section class="alternativas">
            <form action="">
                ...
                <label for="alternativa_c">
                    <input type="radio" id="alternativa_c" name="alternativa" velue="${alterarSinais(quiz.questions[pergunta-1].options[2])}">
...
function guardarResposta(evento){
    ...
    const botaoEnivar = document.querySelector(".alternativas button")
    botaoEnivar.addEventListener("click", validarResposta)
}

function validarResposta (){
    const botaoEnivar = document.querySelector(".alternativas button")
    botaoEnivar.innerText = "proxima"
    botaoEnivar.removeEventListener("click", validarResposta)

    if (pergunta === 10) {
        botaoEnivar.innerText = "Finalizar"
        botaoEnivar.addEventListener("click", finalizar)
    }else{
        botaoEnivar.addEventListener("click", proximaPergunta)
    }
